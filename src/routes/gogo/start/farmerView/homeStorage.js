...
class HomeStorage extends Component {
  render() {
    ...
    return (
      <Fragment>
        <Row>
          ...
          <NavLink to="grains">
            <Card>
              <CardBody>
                <h2><LanguageChanger text="Grains" /></h2>
              </CardBody>
            </Card>
          </NavLink>
          </Colxx>
          ...
          <NavLink to="fruits-vegetables">
            <Card>
              <CardBody>
                <h2><LanguageChanger text="Fruits/Vegetable" /></h2>
              </CardBody>
            </Card>
            </NavLink>
          </Colxx>
      ...
      <CardBody>
        <div>
          <p><LanguageChanger text="In India, the post-harvest losses of
           ...
           of the total food grains produced. This can be attributed to the poor infrastructural
            ...
            <p>
            <LanguageChanger text="In a country where about 20% of the population is undernourished, post-harvest losses of
             ...
             lay a crucial role in preventing losses caused mainly by weevils, beetles, moths and rodents.
              It is estimated that 60–70% of food grain produced in the country is stored at domestic level." />
                ...
                <p><LanguageChanger text=" To ensure safe and scientific storage, careful selection of storage site, storage structure and proper aeration
                 ...
                 temporary and long-term storage methods." /></p>
                   <p><LanguageChanger text=" Bulk storage of
                    ...
                    Warehousing Corporation (CWC/SWC). " /></p>
                     <p><LanguageChanger text="Moisture content is another important parameter which should be
